 ...
 '(
   ...
   (:name magit				; git meet emacs, and a binding
	  :after (progn
		   ...
		   (global-set-key (kbd "C-c m B") 'magit-process-buffer)
		   (define-key evil-normal-state-map (kbd "SPC m B") 'magit-process-buffer)
...
(add-hook 'python-mode-hook
    (lambda () (modify-syntax-entry ?_ "w")
				...
				(defun insert-print ()
				  ...
				  (left-char 2)
				  (evil-insert-state))
				(global-set-key (kbd "C-c d p") 'insert-print)
				(define-key evil-normal-state-map (kbd "SPC d p") 'insert-print)

				(defun insert-formated-string ()
				  (interactive)
				  (insert "\"\" % ()")
				  (left-char 6)
				  (evil-insert-state))
				(global-set-key (kbd "C-c d s") 'insert-formated-string)
				(define-key evil-normal-state-map (kbd "SPC d s") 'insert-formated-string)

				(defun insert-formated-string-print ()
				  (interactive)
				  (insert "print(\"\" % ())")
				  (left-char 7)
				  (evil-insert-state))
				(global-set-key (kbd "C-c d P") 'insert-formated-string-print)
				(define-key evil-normal-state-map (kbd "SPC d P") 'insert-formated-string-print)
				...
				(defun reverse-truth-value () (interactive)
				...
				(define-key evil-normal-state-map (kbd "SPC d i") 'reverse-truth-value)

				(defun insert-python-reminder-comment (keyword) (interactive)
				...
				(define-key evil-normal-state-map (kbd "SPC d c t")
				  (lambda ()
				    (interactive)
				    (insert-python-reminder-comment "TODO")))
				(define-key evil-normal-state-map (kbd "SPC d c f")
				  (lambda ()
				    (interactive)
				    (insert-python-reminder-comment "FIXME")))
				(define-key evil-normal-state-map (kbd "SPC d c x")
				  (lambda ()
				    (interactive)
				    (insert-python-reminder-comment "XXX")))
				))
